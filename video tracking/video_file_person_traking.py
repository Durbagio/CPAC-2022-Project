...
WEIGHTS_PATH = './Models/squeezenet.caffemodel' # for person tracking (person class = 15)
CONFIG_PATH  = './Models/squeezenet.prototxt'
IP = '127.0.0.1'
...
class FaceDetector(BaseObjectDetector):
    ...
    def process_image(self, image: NpImage) -> Sequence[Detection]:
        ...
        blob = cv2.dnn.blobFromImage(image, 1.0, (700, 700), [104, 117, 123], False, False)
        # blob = cv2.dnn.blobFromImage(image, 1.0, (1200, 1200), [104, 117, 123], False, False)
        ...
        for i in range(detections.shape[2]):
            ...
            if obj_class==15: # keep only person class
                ...
                if confidence > self.conf_threshold:
                    ...
                    out_detections.append(Detection(box=[xmin, ymin, xmax, ymax], score=confidence, class_id=obj_class))
